...
$query = mysqli_query($koneksi, "SELECT pesanan.pesanan_id,pesanan.nama_penerima,pesanan.nomor_telepon,pesanan.alamat,pesanan.tanggal_pemesanan,pesanan.email_penerima,user.nama,kota.kota,kota.tarif from pesanan join user on pesanan.user_id=user.user_id join kota on kota.kota_id=pesanan.kota_id where pesanan.pesanan_id='$pesanan_id'");
...
<div id="frame-keterangan-pembayaran">
    <p>Silahkan Lakukan pembayaran ke Bank ABC<br />
        Nomor Account : 0000-9999-8888 (A/N SSIP).<br />
